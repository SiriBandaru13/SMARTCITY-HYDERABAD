...
public class Signup extends JFrame {
	...
	public Signup() {
		...
		background.setBounds(0, 0, 4500, 1600);
		background.setIcon(new ImageIcon("E:\\SmartCity\\smartcity\\images\\pic6.jpg"));
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try
				{
					String query="insert into login (Name,Username,Password,HomeTown) values (?,?,?,?)";
			...
			private void extracted(Welcome w) {
				w.show();
			}
		});
		btnSignUp.addActionListener(new ActionListener() {
